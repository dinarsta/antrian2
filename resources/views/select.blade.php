        ...
        <div class="row justify-content-center">
            <div class="col-md-6">
                ...
                <div class="alert alert-success">
                    {{ session('success') }}
                    <a href="{{ route('print', ['id' => $bpjsEntry->id]) }}" class="mt-2 btn btn-light custom-btn">Lihat Detail Data</a>
                </div>
                @endif
                <form action="{{ route('handle.selection', ['id' => $bpjsEntry->id]) }}" method="post" class="custom-form">
                    @csrf
